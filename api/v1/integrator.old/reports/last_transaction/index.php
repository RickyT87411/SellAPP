...
define("_POST_TRANSACTION_PROC_PROD_", "report_last_transaction_v2");
define("_POST_TRANSACTION_PROC_DEV_", "report_last_transaction_v2");
...
$app->post(
    ...
    function ($request, $response, $args) use ($app) {
    	...
    	try {
			...
			$stmt->bindParam(':_by_date_type',		$data[$_FIELD_MAPPING_["_by_date_type"]]);
			$stmt->execute();
