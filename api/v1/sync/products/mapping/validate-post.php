		...
		foreach($array as $data) {
			...
			test_date_fields_valid(
				...
				array(
					...
					,$_POST_FIELD_MAPPING_["_source_created_at"]
					,$_POST_FIELD_MAPPING_["_source_updated_at"]
				),
				$errs
			);
			...
			test_numeric_fields_valid(
				$data,
				array(
					  $_POST_FIELD_MAPPING_["_vend_version"]
					 ,$_POST_FIELD_MAPPING_["_source_monotonic_version"]
				),
				$errs
			);
