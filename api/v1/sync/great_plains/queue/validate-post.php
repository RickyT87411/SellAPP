...
function validate_post($body = null) { 
	...
	try {
		...
		test_date_fields_valid(
			$data,
			array(
				 $_POST_FIELD_MAPPING_["_date_from"]
				,$_POST_FIELD_MAPPING_["_date_to"]
				,$_POST_FIELD_MAPPING_["_created_from"]
				,$_POST_FIELD_MAPPING_["_created_to"]
				,$_POST_FIELD_MAPPING_["_updated_from"]
				,$_POST_FIELD_MAPPING_["_updated_to"]
			),
			$errs
		);
