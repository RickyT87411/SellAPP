	...
	try {
		...
		test_mandatory_fields_set(
			...
			array(
				...
				,$_PUT_FIELD_MAPPING_["_great_plains_transaction_id"]
				,$_PUT_FIELD_MAPPING_["_great_plains_transaction_type"]
				,$_PUT_FIELD_MAPPING_["_great_plains_transaction_sub_type"]
				,$_PUT_FIELD_MAPPING_["_great_plains_transaction_title"]
				,$_PUT_FIELD_MAPPING_["_great_plains_transaction_status"]
			),
			$errs
		);
