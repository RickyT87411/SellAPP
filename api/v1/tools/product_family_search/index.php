...
define("_GET_PROC_", "tools_product_family_search_v2");
...
$app->get(
    ...
    function ($request, $response, $args) use ($app) {
    	...
    	try {
    		$body = array(
    			 $_GET_FIELD_MAPPING_["_product_sku"] => $request->getParam($_GET_FIELD_MAPPING_["_product_sku"])
    			,$_GET_FIELD_MAPPING_["_product_name"] => $request->getParam($_GET_FIELD_MAPPING_["_product_name"])
			...
			$stmt->bindParam(':_product_sku', 	$data[$_GET_FIELD_MAPPING_["_product_sku"]], PDO::PARAM_STR,256); 
			$stmt->bindParam(':_product_name', 	$data[$_GET_FIELD_MAPPING_["_product_name"]], PDO::PARAM_STR,256); 
			...
			$stmt->bindParam(':_active', 		$data[$_GET_FIELD_MAPPING_["_company"]], PDO::PARAM_BOOL);
