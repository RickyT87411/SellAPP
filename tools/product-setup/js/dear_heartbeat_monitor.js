DearHeartbeatMonitor.prototype._proxy = '/SimplePHPProxy.php';
...
function DearHeartbeatMonitor(id, uri, delay) {
	...
	heartbeat_uri = DearHeartbeatMonitor.prototype._proxy + "?" + jQuery.param( params );
...
DearHeartbeatMonitor.prototype.check = function () {
