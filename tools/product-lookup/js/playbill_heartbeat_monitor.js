PlaybillHeartbeatMonitor.prototype._proxy = '/SimplePHPProxy.php';
...
function PlaybillHeartbeatMonitor(id, uri, delay) { 
	...
	if ( UrlExists(PlaybillHeartbeatMonitor.prototype._proxy) ) {
		var params = {
			"url" : uri,
			"full_status" : 1,
			"full_headers" : 1
		...
		heartbeat_uri = PlaybillHeartbeatMonitor.prototype._proxy + "?" + jQuery.param( params );
...
PlaybillHeartbeatMonitor.prototype.check = function () {
